...
export class migrate1644753240543 implements MigrationInterface {
    name = 'migrate1644753240543'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "habit" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "title" character varying NOT NULL, "category" character varying NOT NULL, "description" character varying NOT NULL, "target" double precision NOT NULL DEFAULT '0', "target_type" character varying NOT NULL, "start" TIMESTAMP, "end" TIMESTAMP, "repeat_every_day" integer, "repeat_on" text NOT NULL, "userId" uuid, CONSTRAINT "PK_71654d5d0512043db43bac9abfc" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "habit_history" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "date" TIMESTAMP NOT NULL, "value" double precision NOT NULL DEFAULT '0', "habitId" uuid, CONSTRAINT "PK_d9f89162c8e45fa205f6bb4ed62" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "habit_history" ADD CONSTRAINT "FK_2bf1727ea25ea7ff570041db18e" FOREIGN KEY ("habitId") REFERENCES "habit"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
